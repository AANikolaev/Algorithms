...
public class RedBlackTreeTest {
    ...
    private static final int MAX_RAND_NUM = +100000;
    private static final int MIN_RAND_NUM = -100000;

    private static final int TEST_SZ = 9000;
    ...
    private static void assertNullChildren(RedBlackTree tree, RedBlackTree.Node... nodes) {
    ...
    private static void assertCorrectParentLinks(
    ...
    private boolean assertBinarySearchTreeInvariant(RedBlackTree tree, RedBlackTree<Integer>.Node node) {
    ...
    // Used for testing.
    private boolean validateParentLinksAreCorrect(RedBlackTree.Node node, RedBlackTree.Node parent) {
        if (node == tree.NIL) return true;
    ...
    private static List<Integer> genRandList(int sz) {
